    ...
    <div class="row">
      <div class="col-xl-9 col-lg-10 col-md-12 col-sm-12 mx-auto">
        <div class="tm-bg-primary-dark tm-block tm-block-h-auto">
          <div class="row"> 
            <div class="col-12">
              <h2 class="tm-block-title d-inline-block"> Effectuer une modification de reapprovisionnement </h2>
            </div>
          </div>
          <div class="row tm-edit-product-row">
            <div class="col-xl-6 col-lg-6 col-md-12">
              <form action="/update_reapprovisionnement" method="post" class="tm-edit-product-form">
                  @csrf
                <div class="form-group mb-3">
                  ...
                  <input
                    ...
                    name="nom_produit"
                    type="text"
                    value="{{$approvisionnement->nom_produit}}"
                ...
                <div class="form-group mb-3">
                  ...
                  <input
                    ...
                    name="qte_commandee"
                    type="number"
                    value="{{$approvisionnement->qte_commandee}}"
                    class="form-control validate"
                    required
                  />
                </div>
            ...
            <div class="col-xl-6 col-lg-6 col-md-12 mx-auto mb-4">
              <div class="form-group mb-3">
                  ...
                  <input
                    ...
                    type="date"
                    value="{{$approvisionnement->date_reapprovisionnement}}"
                    class="form-control validate"
                    required
                  />
              </div>
              <div class="form-group mb-3">
                  ...
                  <input
                    ...
                    name="montant_total"
                    type="number"
                    value="{{$approvisionnement->montant_total}}"
                    class="form-control validate"
                    required
                  />
              </div>
              <div class="form-group mb-3">
                ...
                >
                  <option value="{{$approvisionnement->status}}" selected> {{$approvisionnement->status}} </option>
                  <option value="livré"> livré </option>
                </select>

            </div>

            <input type="hidden" value="{{$approvisionnement->id}}" id="{{$approvisionnement->id}}" name="id">
            </div>
            <div class="col-12">
              <input type="submit" class="btn btn-primary btn-block text-uppercase" name="save" value="modifiez le reapprovisionnement" >
            </div>
          </form>
          </div>
        </div>
