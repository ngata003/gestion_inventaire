      ...
      <div class="row tm-content-row">
        <div class="col-sm-12 col-md-12 col-lg-8 col-xl-8 tm-block-col">
          <div class="tm-bg-primary-dark tm-block tm-block-products">
            <div class="tm-product-table-container">
              @if (session('success_fournisseur'))
                <p style="color:orange"> {{session('success_fournisseur')}}</p>
              @endif
              @if (session('update_fournisseur'))
              <p style="color:orange"> {{session('update_fournisseur')}}</p>
              @endif
              @if (session('delete_fournisseur'))
              <p style="color:orange"> {{session('delete_fournisseur')}}</p>
              @endif
              <table class="table table-hover tm-table-small tm-product-table">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="tm-product-name"> {{$fournis->nom_fournisseur}} </td>
                        <td> {{$fournis->email_fournisseur}} </td>
                        <td> {{$fournis->contact_fournisseur}} </td>
                        <td> {{$fournis->pays}}</td>
                        <td>
                          <a href="/delete_fournisseurs/{{$fournis->id}}" class="tm-product-delete-link">
                            <i class="far fa-trash-alt tm-product-delete-icon"></i>
                          </a>
                          <a href="/update_fournisseurs/{{$fournis->id}}" class="tm-product-delete-link">
        ...
        <div class="col-sm-12 col-md-12 col-lg-4 col-xl-4 tm-block-col">
          <div class="tm-bg-primary-dark tm-block tm-block-product-categories">
            <h2 class="tm-block-title"> Rechercher fournisseurs </h2>
            <div class="tm-product-table-container">
              <table class="table tm-table-small tm-product-table">
                <tbody>
                    <tr>
                        <td colspan="2" class="tm-product-name">
                          <form action="/research_fournisseurs" method="GET" style="display: flex; align-items: center;">
                            <input
                              type="text"
                              name="search"
