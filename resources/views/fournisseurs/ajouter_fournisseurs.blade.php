        ...
        <div class="tm-bg-primary-dark tm-block tm-block-h-auto">
          ...
          <div class="row tm-edit-product-row">
            <div class="col-xl-6 col-lg-6 col-md-12">
                ...
                @endif
              <form action="/add_fournisseurs" method="post" class="tm-edit-product-form">
                  @csrf
            ...
            <div class="col-12">
              <input type="submit" class="btn btn-primary btn-block text-uppercase" name="save" value="enregistrez le fournisseur" >
            </div>
          </form>
          </div>
        </div>
