      ...
      <div class="row">
        <div class="col-xl-9 col-lg-10 col-md-12 col-sm-12 mx-auto">
          <div class="tm-bg-primary-dark tm-block tm-block-h-auto">
            <div class="row">
              <div class="col-12">
                <h2 class="tm-block-title d-inline-block"> modifier un gestionnaire </h2>
              </div>
            </div>
            <div class="row tm-edit-product-row">
              <div class="col-xl-6 col-lg-6 col-md-12">
                ...
                <form action="/update_gestionnaires_traitement" method="POST" enctype="multipart/form-data" class="tm-edit-product-form">
                @csrf
                  ...
                  <div class="form-group mb-3">
                    ...
                    <select
                      ...
                      required
                    >
                      <option selected value="{{$gestionnaire->role}}">Selectionner un role </option>
                  ...
                  <div class="form-group mb-3">
                    ...
                    <input
                      ...
                      name="contact"
                      value="{{$gestionnaire->contact}}"
                      type="tel"
                      class="form-control validate"
                    />
                  </div>

                  <input type="hidden" value="{{$gestionnaire->id}}" name="id" id="">
              </div>
              <div class="col-xl-6 col-lg-6 col-md-12 mx-auto mb-4">
                <div class="tm-product-img-dummy mx-auto" onclick="document.getElementById('fileInput').click();" style="cursor:pointer;">
                    <img id="previewImage" src="{{asset('img/'.$gestionnaire->image_utilisateur)}}" alt="Image à remplacer"
              ...
              <div class="col-12">
                <button type="submit" class="btn btn-primary btn-block text-uppercase">modifier le gestionnaire  </button>
              </div>
            </form>
            </div>
          </div>
