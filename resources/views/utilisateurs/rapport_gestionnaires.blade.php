      ...
      <div class="row tm-content-row">
              ...
              <table class="table table-hover tm-table-small tm-product-table">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="tm-product-name"> {{$gest->name}} </td>
                        <td> {{$gest->contact}} </td>
                        <td> {{$gest->role}} </td>
                        <td> {{$gest->email}}</td>
                        <td>
                          <a href="/delete_gestionnaire/{{$gest->id}}" class="tm-product-delete-link">
                            <i class="far fa-trash-alt tm-product-delete-icon"></i>
                          </a>
                          <a href="/update_gestionnaires/{{$gest->id}}" class="tm-product-delete-link">
        ...
        <div class="col-sm-12 col-md-12 col-lg-4 col-xl-4 tm-block-col">
          <div class="tm-bg-primary-dark tm-block tm-block-product-categories">
            <h2 class="tm-block-title"> Rechercher gestionnaires </h2>
            <div class="tm-product-table-container">
              <table class="table tm-table-small tm-product-table">
                <tbody>
                    <tr>
                        <td colspan="2" class="tm-product-name">
                          <form action="/research_gestionnaires" method="GET" style="display: flex; align-items: center;">
                            <input
                              type="text"
                              name="search"
