          ...
          <div class="tm-bg-primary-dark tm-block tm-block-products">
            <div class="tm-product-table-container">
              <table class="table table-hover tm-table-small tm-product-table">
                ...
                <tbody>
                    @foreach ($research as $vente )
                    <tr>
                        <th scope="row">{{$vente->id}}</th>
                        <td class="tm-product-name"> {{$vente->nom_client}}</td>
                        <td>{{$vente->montant_total}}</td>
                        <td>{{$vente->montant_paye}}</td>
                        <td>{{$vente->remboursement}}</td>
                        <td> {{$vente->created_at->format('d-m-y')}}</td>
                        <td>
                            <a href="/delete_ventes/{{$vente->id}}" class="tm-product-delete-link">
                              <i class="far fa-trash-alt tm-product-delete-icon"></i>
                            </a>
                            <a href="/voir_facture/{{$vente->id}}" class="tm-product-delete-link">
